...
let text = document.createTextNode(`Id: <input type="text" id="id"><br>\n Name: <input type="text" id="name"><br>\n Phone: <input type="text" id="phone"><br>\n <input type="submit" value="전송">` )
formTag.appendChild(text);

document.getElementById('show').appendChild(formTag);
